...
DOFrame_fb::DOFrame_fb( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	sbSizer1 = new wxStaticBoxSizer( new wxStaticBox( m_pnControls, wxID_ANY, wxT("Trigger") ), wxHORIZONTAL );
	
	wxBoxSizer* bSizer4;
	bSizer4 = new wxBoxSizer( wxHORIZONTAL );
	
	m_slTrgLevel = new wxSlider( m_pnControls, ID_TR_LEVEL, -250, -500, 500, wxDefaultPosition, wxSize( 20,-1 ), wxSL_VERTICAL|wxSTATIC_BORDER );
	m_slTrgLevel->SetToolTip( wxT("Set Trigger Level") );
	
	bSizer4->Add( m_slTrgLevel, 0, wxEXPAND|wxRIGHT, 5 );
	...
	bSizer7->Add( m_rbNormal, 0, wxALL, 5 );
	...
	bSizer7->Add( m_rbAuto, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	...
	bSizer6->Add( m_bpPolarity, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_btTrgCfg = new wxButton( m_pnControls, ID_TRGCFG, wxT("Config"), wxDefaultPosition, wxSize( 45,-1 ), 0 );
	m_btTrgCfg->Enable( false );
	
	bSizer6->Add( m_btTrgCfg, 0, wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_rbS0 = new wxRadioButton( m_pnControls, ID_TRG1, wxT("1"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
	m_rbS0->SetValue( true ); 
	m_rbS0->SetToolTip( wxT("Select CH1 as trigger source") );
	
	bSizer18->Add( m_rbS0, 1, wxEXPAND|wxTOP|wxBOTTOM, 5 );
	
	m_rbS1 = new wxRadioButton( m_pnControls, ID_TRG2, wxT("2"), wxDefaultPosition, wxDefaultSize, 0 );
	m_rbS1->SetToolTip( wxT("Select CH2 as trigger source") );
	
	bSizer18->Add( m_rbS1, 1, wxTOP|wxBOTTOM|wxEXPAND, 5 );
	
	m_rbS2 = new wxRadioButton( m_pnControls, ID_TRG3, wxT("3"), wxDefaultPosition, wxDefaultSize, 0 );
	m_rbS2->SetToolTip( wxT("Select CH3 as trigger source") );
	
	bSizer18->Add( m_rbS2, 1, wxTOP|wxBOTTOM|wxEXPAND, 5 );
	
	m_rbS3 = new wxRadioButton( m_pnControls, ID_TRG4, wxT("4"), wxDefaultPosition, wxDefaultSize, 0 );
	m_rbS3->SetToolTip( wxT("Select CH4 as trigger source") );
	
	bSizer18->Add( m_rbS3, 1, wxTOP|wxBOTTOM|wxEXPAND, 5 );
	
	m_rbS4 = new wxRadioButton( m_pnControls, ID_TRG5, wxT("EXT"), wxDefaultPosition, wxDefaultSize, 0 );
	m_rbS4->SetToolTip( wxT("Select LEMO external trigger source") );
	
	bSizer18->Add( m_rbS4, 0, wxEXPAND|wxTOP|wxBOTTOM, 5 );
	...
	m_stHScale->Wrap( -1 );
	m_stHScale->SetFont( wxFont( 10, 74, 90, 92, false, wxEmptyString ) );
	...
	sbSizer2->Add( bSizer20, 1, wxEXPAND, 5 );
	
	m_slHOffset = new wxSlider( m_pnControls, ID_TR_DELAY, 0, -1000, 1000, wxDefaultPosition, wxSize( -1,20 ), wxSL_HORIZONTAL|wxSTATIC_BORDER );
	m_slHOffset->SetToolTip( wxT("Set Horizontal Position") );
	
	sbSizer2->Add( m_slHOffset, 0, wxEXPAND|wxTOP, 3 );
	...
	m_btCh1 = new wxToggleButton( m_pnControls, ID_CHON1, wxT("1"), wxDefaultPosition, wxSize( 0,27 ), 0 );
	m_btCh1->SetValue( true ); 
	m_btCh1->SetFont( wxFont( 12, 74, 90, 92, false, wxEmptyString ) );
	m_btCh1->SetToolTip( wxT("Enable Channel 1") );
	
	bSizer9->Add( m_btCh1, 0, wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	...
	m_stScale1 = new wxStaticText( m_pnControls, wxID_ANY, wxT("Scale"), wxDefaultPosition, wxSize( -1,-1 ), wxALIGN_CENTRE|wxST_NO_AUTORESIZE );
	m_stScale1->Wrap( -1 );
	...
	m_btCh2 = new wxToggleButton( m_pnControls, ID_CHON2, wxT("2"), wxDefaultPosition, wxSize( 0,27 ), 0 );
	m_btCh2->SetValue( true ); 
	m_btCh2->SetFont( wxFont( 12, 74, 90, 92, false, wxEmptyString ) );
	m_btCh2->SetToolTip( wxT("Enable Channel 2") );
	
	bSizer10->Add( m_btCh2, 0, wxEXPAND, 5 );
	...
	m_stScale2 = new wxStaticText( m_pnControls, wxID_ANY, wxT("Scale"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE|wxST_NO_AUTORESIZE );
	m_stScale2->Wrap( -1 );
	...
	m_btCh3 = new wxToggleButton( m_pnControls, ID_CHON3, wxT("3"), wxDefaultPosition, wxSize( 0,27 ), 0 );
	m_btCh3->SetFont( wxFont( 12, 74, 90, 92, false, wxEmptyString ) );
	m_btCh3->SetToolTip( wxT("Enable Channel 3") );
	
	bSizer11->Add( m_btCh3, 0, wxEXPAND, 5 );
	...
	m_stScale3 = new wxStaticText( m_pnControls, wxID_ANY, wxT("Scale"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE|wxST_NO_AUTORESIZE );
	m_stScale3->Wrap( -1 );
	...
	m_btCh4 = new wxToggleButton( m_pnControls, ID_CHON4, wxT("4"), wxDefaultPosition, wxSize( 0,27 ), 0 );
	m_btCh4->SetFont( wxFont( 12, 74, 90, 92, false, wxEmptyString ) );
	m_btCh4->SetToolTip( wxT("Enable Channel 4") );
	
	bSizer13->Add( m_btCh4, 0, wxEXPAND, 5 );
	...
	m_stScale4 = new wxStaticText( m_pnControls, wxID_ANY, wxT("Scale"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE|wxST_NO_AUTORESIZE );
	m_stScale4->Wrap( -1 );
	...
	sbSizer8 = new wxStaticBoxSizer( new wxStaticBox( m_pnControls, wxID_ANY, wxT("Cursor") ), wxVERTICAL );
	
	wxBoxSizer* bSizer131;
	bSizer131 = new wxBoxSizer( wxHORIZONTAL );
	
	m_toggleCursorA = new wxToggleButton( m_pnControls, ID_CURSORA, wxT("&A"), wxDefaultPosition, wxSize( 25,-1 ), 0 );
	m_toggleCursorA->SetToolTip( wxT("Activate Cursor A") );
	
	bSizer131->Add( m_toggleCursorA, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );
	
	m_toggleCursorB = new wxToggleButton( m_pnControls, ID_CURSORB, wxT("&B"), wxDefaultPosition, wxSize( 25,-1 ), 0 );
	m_toggleCursorB->SetToolTip( wxT("Activate Cursor B") );
	
	bSizer131->Add( m_toggleCursorB, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );
	
	m_checkBox8 = new wxCheckBox( m_pnControls, wxID_ANY, wxT("Snap"), wxDefaultPosition, wxDefaultSize, 0 );
	m_checkBox8->SetValue(true); 
	bSizer131->Add( m_checkBox8, 1, wxALIGN_CENTER_HORIZONTAL|wxEXPAND|wxTOP|wxBOTTOM|wxLEFT, 5 );
	...
	sbSizer4 = new wxStaticBoxSizer( new wxStaticBox( m_pnControls, wxID_ANY, wxT("Utility") ), wxVERTICAL );
	...
	sbSizer4->Add( gSizer1, 0, wxEXPAND, 5 );
	...
	sbSizer9->Add( m_btAbout, 1, wxALIGN_CENTER_VERTICAL|wxTOP|wxEXPAND, 5 );
	...
	sbSizer9->Add( m_btExit, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND|wxTOP, 5 );
	...
	bSizer1->Add( m_pnControls, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 0 );
	...
	m_rbS0->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( DOFrame_fb::OnTrgButton ), NULL, this );
	m_rbS1->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( DOFrame_fb::OnTrgButton ), NULL, this );
	m_rbS2->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( DOFrame_fb::OnTrgButton ), NULL, this );
	m_rbS3->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( DOFrame_fb::OnTrgButton ), NULL, this );
	m_rbS4->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( DOFrame_fb::OnTrgButton ), NULL, this );
...
DOFrame_fb::~DOFrame_fb()
{
	...
	m_rbS0->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( DOFrame_fb::OnTrgButton ), NULL, this );
	m_rbS1->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( DOFrame_fb::OnTrgButton ), NULL, this );
	m_rbS2->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( DOFrame_fb::OnTrgButton ), NULL, this );
	m_rbS3->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( DOFrame_fb::OnTrgButton ), NULL, this );
	m_rbS4->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( DOFrame_fb::OnTrgButton ), NULL, this );
...
ConfigDialog_fb::ConfigDialog_fb( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	sbSizer5111 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, wxT("Board") ), wxHORIZONTAL );
	
	wxArrayString m_cbBoardChoices;
	m_cbBoard = new wxChoice( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_cbBoardChoices, 0 );
	m_cbBoard->SetSelection( 0 );
	sbSizer5111->Add( m_cbBoard, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND|wxTOP|wxBOTTOM, 5 );
	
	m_btScan = new wxButton( this, wxID_ANY, wxT("Rescan"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer5111->Add( m_btScan, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxLEFT, 5 );
	
	m_btInfo = new wxButton( this, wxID_ANY, wxT("Info"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer5111->Add( m_btInfo, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxLEFT, 5 );
	...
	m_rb1_4 = new wxRadioButton( this, ID_1_4, wxT(" 1 to 4"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
	m_rb1_4->SetValue( true ); 
	bSizer1812->Add( m_rb1_4, 1, wxALL|wxEXPAND, 5 );
	
	m_rb5_8 = new wxRadioButton( this, ID_5_8, wxT(" 5 to 8"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer1812->Add( m_rb5_8, 1, wxALL|wxEXPAND, 5 );
	
	m_rb9_12 = new wxRadioButton( this, ID_9_12, wxT(" 9 to 12"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer1812->Add( m_rb9_12, 1, wxALL|wxEXPAND, 5 );
	
	m_rb13_16 = new wxRadioButton( this, ID_13_16, wxT(" 13 to 16"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer1812->Add( m_rb13_16, 1, wxALL|wxEXPAND, 5 );
	
	sbSizer511->Add( bSizer1812, 0, wxEXPAND|wxRIGHT|wxLEFT, 5 );
	
	wxBoxSizer* bSizer1811;
	bSizer1811 = new wxBoxSizer( wxHORIZONTAL );
	
	m_rbLower = new wxRadioButton( this, ID_LOWER, wxT(" lower half"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
	m_rbLower->SetValue( true ); 
	bSizer1811->Add( m_rbLower, 0, wxALL, 5 );
	
	m_rbUpper = new wxRadioButton( this, ID_UPPER, wxT(" upper half"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer1811->Add( m_rbUpper, 0, wxALL, 5 );
	
	m_rbCombined = new wxRadioButton( this, ID_COMBINED, wxT(" combined"), wxDefaultPosition, wxDefaultSize, 0 );
	m_rbCombined->Enable( false );
	
	bSizer1811->Add( m_rbCombined, 0, wxALL, 5 );
	
	sbSizer511->Add( bSizer1811, 0, wxALIGN_CENTER_HORIZONTAL|wxRIGHT|wxLEFT, 5 );
	
	m_cbClkOn = new wxCheckBox( this, wxID_ANY, wxT("Connect reference clock to channel #4"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer511->Add( m_cbClkOn, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	
	bSizer12->Add( sbSizer511, 0, wxEXPAND|wxRIGHT|wxLEFT, 5 );
	
	wxStaticBoxSizer* sbSizer51;
	sbSizer51 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, wxT("Input Range") ), wxVERTICAL );
	
	wxBoxSizer* bSizer181;
	bSizer181 = new wxBoxSizer( wxHORIZONTAL );
	
	m_rbR0 = new wxRadioButton( this, ID_R0, wxT("  -0.5V to +0.5V"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
	m_rbR0->SetValue( true ); 
	bSizer181->Add( m_rbR0, 1, wxALL|wxEXPAND, 5 );
	
	m_rbR045 = new wxRadioButton( this, ID_R045, wxT("  -0.05V to +0.95V"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer181->Add( m_rbR045, 0, wxALL, 5 );
	
	m_rbR05 = new wxRadioButton( this, ID_R05, wxT("  0V to +1V"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer181->Add( m_rbR05, 1, wxALL|wxEXPAND, 5 );
	
	sbSizer51->Add( bSizer181, 0, wxEXPAND, 5 );
	
	bSizer12->Add( sbSizer51, 0, wxEXPAND|wxRIGHT|wxLEFT, 5 );
	...
	sbSizer5->Add( m_cbCalibrated, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	sbSizer5->Add( m_gaugeCalVolt, 0, wxALL|wxEXPAND, 5 );
	...
	sbSizer6->Add( m_cbRotated, 0, wxTOP|wxRIGHT|wxLEFT, 5 );
	
	m_cbTCalOn = new wxCheckBox( this, ID_DISP_TCALIBRATED, wxT("Display timing calibrated waveforms"), wxDefaultPosition, wxDefaultSize, 0 );
	m_cbTCalOn->SetValue(true); 
	sbSizer6->Add( m_cbTCalOn, 0, wxTOP|wxRIGHT|wxLEFT, 5 );
	...
	sbSizer6->Add( m_gaugeCalTime, 0, wxALL|wxEXPAND, 5 );
	
	bSizer12->Add( sbSizer6, 0, wxEXPAND|wxRIGHT|wxLEFT, 5 );
	...
	m_rb1_4->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rb5_8->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rb9_12->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rb13_16->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rbLower->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rbUpper->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rbCombined->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_cbClkOn->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ConfigDialog_fb::OnClkOn ), NULL, this );
	m_rbR0->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnInputRange ), NULL, this );
	m_rbR045->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnInputRange ), NULL, this );
	m_rbR05->Connect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnInputRange ), NULL, this );
...
ConfigDialog_fb::~ConfigDialog_fb()
{
	...
	m_rb1_4->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rb5_8->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rb9_12->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rb13_16->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rbLower->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rbUpper->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rbCombined->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_cbClkOn->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ConfigDialog_fb::OnClkOn ), NULL, this );
	m_rbR0->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnInputRange ), NULL, this );
	m_rbR045->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnInputRange ), NULL, this );
	m_rbR05->Disconnect( wxEVT_COMMAND_RADIOBUTTON_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnInputRange ), NULL, this );
...
DisplayDialog_fb::DisplayDialog_fb( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText16 = new wxStaticText( this, wxID_ANY, wxT("FFT"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText16->Wrap( -1 );
	gSizer2->Add( m_staticText16, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_checkBox9 = new wxCheckBox( this, ID_FFT1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	gSizer2->Add( m_checkBox9, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_checkBox10 = new wxCheckBox( this, ID_FFT2, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	gSizer2->Add( m_checkBox10, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_checkBox11 = new wxCheckBox( this, ID_FFT3, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	gSizer2->Add( m_checkBox11, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_checkBox12 = new wxCheckBox( this, ID_FFT4, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_checkBox9->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( DisplayDialog_fb::OnButton ), NULL, this );
	m_checkBox10->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( DisplayDialog_fb::OnButton ), NULL, this );
	m_checkBox11->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( DisplayDialog_fb::OnButton ), NULL, this );
	m_checkBox12->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( DisplayDialog_fb::OnButton ), NULL, this );
...
DisplayDialog_fb::~DisplayDialog_fb()
{
	...
	m_checkBox9->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( DisplayDialog_fb::OnButton ), NULL, this );
	m_checkBox10->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( DisplayDialog_fb::OnButton ), NULL, this );
	m_checkBox11->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( DisplayDialog_fb::OnButton ), NULL, this );
	m_checkBox12->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( DisplayDialog_fb::OnButton ), NULL, this );
...
MeasureDialog_fb::MeasureDialog_fb( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	gSizer2->Add( m_staticline4, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxEXPAND|wxALL, 5 );
	
	m_staticline41 = new wxStaticLine( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	gSizer2->Add( m_staticline41, 0, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticline42 = new wxStaticLine( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	gSizer2->Add( m_staticline42, 0, wxEXPAND|wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticline43 = new wxStaticLine( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	gSizer2->Add( m_staticline43, 0, wxEXPAND|wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticline44 = new wxStaticLine( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	gSizer2->Add( m_staticline44, 0, wxEXPAND|wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_staticText231 = new wxStaticText( this, wxID_ANY, wxT("CH(x)-CH(x+1) delay"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizer19->Add( m_cbStat, 1, wxALL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );
	
	m_button15 = new wxButton( this, wxID_ANY, wxT("Clear"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer19->Add( m_button15, 0, wxALL, 5 );
	...
	m_staticText27 = new wxStaticText( this, wxID_ANY, wxT("Average over"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText27->Wrap( -1 );
	bSizer25->Add( m_staticText27, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_cbNAverage = new wxComboBox( this, wxID_ANY, wxT("100"), wxDefaultPosition, wxDefaultSize, 0, NULL, wxTE_PROCESS_ENTER );
	...
	bSizer25->Add( m_staticText271, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	bSizer14->Add( bSizer25, 1, wxEXPAND, 5 );
...
TriggerDialog_fb::TriggerDialog_fb( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	bSizer35->Add( m_staticText12, 1, wxALIGN_CENTER_HORIZONTAL|wxALL, 4 );
	...
	bSizer35->Add( m_staticText13, 1, wxALIGN_CENTER_HORIZONTAL|wxALL, 4 );
	...
	bSizer35->Add( m_staticText14, 1, wxALIGN_CENTER_HORIZONTAL|wxALL, 4 );
	...
	bSizer35->Add( m_staticText15, 1, wxALIGN_CENTER_HORIZONTAL|wxALL, 4 );
	...
	bSizer35->Add( m_staticText16, 1, wxALIGN_CENTER_HORIZONTAL|wxALL, 4 );
	
	bSizer14->Add( bSizer35, 1, wxALIGN_CENTER_HORIZONTAL|wxEXPAND|wxBOTTOM, 5 );
	...
	m_cbMultiBoard = new wxCheckBox( this, wxID_ANY, wxT("Multi-board trigger mode"), wxDefaultPosition, wxDefaultSize, 0 );
	m_cbMultiBoard->Enable( false );
	
	bSizer39->Add( m_cbMultiBoard, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	bSizer14->Add( bSizer39, 0, wxEXPAND, 5 );
	
	m_staticline25 = new wxStaticLine( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	bSizer14->Add( m_staticline25, 0, wxALL|wxEXPAND, 5 );
...
AboutDialog_fb::AboutDialog_fb( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText18 = new wxStaticText( this, wxID_ANY, wxT("DRS Oscilloscope"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText18->Wrap( -1 );
	m_staticText18->SetFont( wxFont( 16, 70, 90, 90, false, wxEmptyString ) );
	
	bSizer17->Add( m_staticText18, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 10 );
	...
	m_bitmap1 = new wxStaticBitmap( this, wxID_ANY, wxBitmap( drsosc_xpm ), wxDefaultPosition, wxSize( 200,-1 ), 0 );
	bSizer17->Add( m_bitmap1, 1, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 10 );
	...
	m_hyperlink1 = new wxHyperlinkCtrl( this, wxID_ANY, wxT("http://drs.web.psi.ch"), wxT("http://drs.web.psi.ch"), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
...
InfoDialog_fb::InfoDialog_fb( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText47->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	m_staticText49->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	m_staticText57->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	m_staticText59->Wrap( -1 );
	m_staticText59->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	...
	m_staticText61->Wrap( -1 );
	m_staticText61->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
