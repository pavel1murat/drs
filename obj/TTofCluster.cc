...
ClassImp(TTofCluster)

//_____________________________________________________________________________
TTofCluster::TTofCluster() : TObject() {
  fNCrystals = 0;
  fCharge = 0;
  fPH = 0;
}
...
//_____________________________________________________________________________
TTofCluster::~TTofCluster() {
}

// //_____________________________________________________________________________
// int TTofCluster::Init(int Side , int Wedge, int View, 
...
//_____________________________________________________________________________
void TTofCluster::Print(Option_t* Option) const {
