...
#include "drs/obj/TTofChannelID.hh"


ClassImp(TTofChannelID)

//_____________________________________________________________________________
TTofChannelID::TTofChannelID() {
}

//_____________________________________________________________________________
TTofChannelID::TTofChannelID(int Number, int Module, int IX, int IY) {
  Set(Number,Module,IX,IY);
}
...
// //_____________________________________________________________________________
// int TTofChannelID::Init(int Side , int Wedge, int View, 
...
//_____________________________________________________________________________
void TTofChannelID::Print(Option_t* Option) const {
