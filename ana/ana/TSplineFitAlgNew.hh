#ifndef TSplineFitAlgNew_hh
#define TSplineFitAlgNew_hh
...
class TSplineFitAlgNew: public TDrsFitAlgNew {
public:
//-----------------------------------------------------------------------------
//
//-----------------------------------------------------------------------------
  ...
  static TSpline*  fgSpline;
//-----------------------------------------------------------------------------
//
//-----------------------------------------------------------------------------
  TSplineFitAlgNew(const char* Name="spln", const char* Title="spln", int NChannels = 1);
  ~TSplineFitAlgNew();
