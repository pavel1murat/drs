...
int init() {
  ...
  drs->GetChannel(0)->SetBaseOffset(3.1);
  drs->GetChannel(1)->SetBaseOffset(3.7);

  drs->GetChannel(0)->SetMinThreshold(20);
  drs->GetChannel(1)->SetMinThreshold(20);

  drs->GetChannel(0)->SetQPeak(122.1);  // sigma = 6.14
  drs->GetChannel(1)->SetQPeak(142.6);	// sigma = 8.5
