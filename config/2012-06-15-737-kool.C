...
int init() {
  ...
  drs->GetChannel(0)->SetBaseOffset(2.9);
  drs->GetChannel(1)->SetBaseOffset(3.4);

  drs->GetChannel(0)->SetMinThreshold(20);
  drs->GetChannel(1)->SetMinThreshold(20);

  drs->GetChannel(0)->SetQPeak(138.5);  // sigma = 7.98
  drs->GetChannel(1)->SetQPeak(158.4);	// sigma = 8.30
