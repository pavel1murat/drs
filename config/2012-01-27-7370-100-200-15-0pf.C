...
//-----------------------------------------------------------------------------
  ...
  expo->SetMinMaxFractions(0,0.02,0.40);
  expo->SetMinMaxFractions(2,0.02,0.40);
