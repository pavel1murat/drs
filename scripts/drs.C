//-----------------------------------------------------------------------------
// reads an XML file and writes a ROOT tree with objects into a file...
// returns pointer to created tree
// doesn't close the file....
// call: drs(const char* ifname="sipm_25pe.xml", Int_t events=0)
//
//-----------------------------------------------------------------------------
#include <TFile.h>
#include <TTree.h>
